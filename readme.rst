...
fields
   Имена полей в файле, нужные поля должны совпадать с именем в описанни доступных полей. По умолчанию: []
type
...
banktitle
   Название банка. По умолчанию: ''
statementfile
   Стандартное имя файла выписки. По умолчанию: ''
description
   Описание. По умолчанию: ''
long_descr
   Длинное описание. По умолчанию: ''
vars
   Пременные нужные для конкретного банка. Переопределяются в ini. По умолчанию: {}
